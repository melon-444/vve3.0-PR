...
execute positioned 199.5 -41.5 52.5 rotated 0.0 0.0 as @e[tag=math_marker,limit=1] run function vve:object/_anchor_to
execute positioned 199.5 -41.5 52.5 rotated 0.0 0.0 positioned ~ ~ ~8.0 as @e[tag=math_marker,limit=1] run function vve:object/_rotate_here
...
data modify storage vve:io input set from storage vve:class cublock_plate
function vve:cublock/_proj
execute positioned 201.5 -41.5 52.5 rotated 0.0 0.0 as @e[tag=math_marker,limit=1] run function vve:object/_anchor_to
execute positioned 201.5 -41.5 52.5 rotated 0.0 0.0 positioned ~ ~ ~8.0 as @e[tag=math_marker,limit=1] run function vve:object/_rotate_here
