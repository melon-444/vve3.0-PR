...
#execute if score test_n int matches 47 run function vve:shift/_print
#execute if score test_n int matches 47 run function vve:impulse/_print
#execute if score test_n int matches 47 run function vve:couple/_print
#execute if score test_n int matches 47 run scoreboard players set test int 1
